...
export default function FinalEvaluationModuleZero() {
  ...
  const QUIZ = [
    {
      question: "¿Para qué nos sirve instalar un 'Motor' (como Node.js) en nuestra computadora?",
      options: [
        "Para que Google Chrome funcione más rápido al ver videos.",
        "Para permitir que la PC entienda instrucciones de programación sin depender del navegador web.",
        "Para tener una interfaz con botones bonitos donde diseñar logotipos."
      ],
      correct: 1,
      feedback: "¡Exacto! Funciona como un traductor invisible (el motor del auto) que corre en el fondo para ejecutar tus programas."
    },
    {
      question: "Si quiero usar Claude a diario sin límites frustrantes y sin sorpresas a fin de mes, debo:",
      options: [
        "Pagar una Suscripción Pro (tarifa plana mensual).",
        "Generar una API Key y asociar mi tarjeta de crédito.",
        "Crear 5 cuentas gratuitas con diferentes correos."
      ],
      correct: 0,
      feedback: "¡Correcto! La suscripción es el camino seguro. Las API Keys te cobran por consumo y pueden resultar en facturas sorpresa."
    },
    {
      question: "¿Por qué decimos que la Inteligencia Artificial NO es magia?",
      options: [
        "Porque es un programa que busca patrones matemáticos en grandes cantidades de datos para predecir lógicamente la respuesta.",
        "Porque en realidad hay un humano detrás escribiendo rápido las respuestas.",
        "Porque solo funciona si estás conectado a una base de datos de Google."
      ],
      correct: 0,
      feedback: "¡Perfecto! La IA es simplemente una calculadora extremadamente avanzada, no es un cerebro consciente."
    }
  ];
    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-24 font-sans text-white">
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-6">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-[#8b7bff] flex items-center justify-center shadow-lg">
            <Award className="w-8 h-8 text-white" />
          </div>
          <div>
            <h1 className="text-3xl font-bold tracking-tight mb-2">
              Evaluación Final - Módulo 0
            </h1>
            <p className="text-gray-400">
              Certifica tus conocimientos técnicos antes de avanzar a la creación de tu primera aplicación.
            </p>
          </div>
        </div>
      </motion.section>
